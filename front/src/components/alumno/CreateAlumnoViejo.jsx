...
import { getSucursales, postAlu, postAluSimple } from "../queris/queris";
      ...
      <div className="p-4 border rounded-lg shadow-md text-center w-1/2">
        ...
        <div className="mt-4 flex justify-center items-center">
          <div className="flex flex-col">
            ...
            <input type="text" name="name" value={formAlu.name} placeholder="matias ahumada" onChange={handleChange} className="p-2 border rounded" />
          </div>
        </div>
