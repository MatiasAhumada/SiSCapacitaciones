...
const CreateCaja = () => {
  ...
  const handleSubmit = async (e) => {
    const { fecha, vendedorId, tipo, alumnoId, cuota, descripcion, monto, metodoPago } = e.target;
    e.preventDefault();
    //console.log(fecha.value, metodoPago.value, vendedorId.value, tipo.value, alumnoId.value, cuota.value, descripcion.value, monto.value);
    setPause(true);
    //ARMO COMPROBANTE
