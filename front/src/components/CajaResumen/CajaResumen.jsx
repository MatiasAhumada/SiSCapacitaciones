    ...
    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
        ...
        <div className="bg-green-50 p-4 rounded-lg">
          ...
          <p className="text-lg font-bold text-green-800">{formatMoney(sesionCaja.totalIngresos)}</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        ...
        <div className="bg-gray-50 p-3 rounded-lg text-center">
          ...
          <p className="text-sm font-bold text-gray-800">{formatMoney(sesionCaja.totalDigitalJavier)}</p>
        </div>
        
        <div className="bg-gray-50 p-3 rounded-lg text-center">
          <p className="text-xs text-gray-600">Digital Tobias</p>
          <p className="text-sm font-bold text-gray-800">{formatMoney(sesionCaja.totalDigitalTobias)}</p>
        </div>
